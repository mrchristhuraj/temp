...
?>
    ...
    <head>
        <title>SRM eVerify Faculty Register</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 l10 offset-l1 m12 ">
                    <div class="card">
                    <div class="login red white-text">FACULTY REGISTRATION</div>
                        <div class="card-content">
                            ...
                            <div class="row center">
                                    <a class="waves-effect waves-light btn-flat pink white-text" id="button"><b>Register</b></a>
                            </div>
