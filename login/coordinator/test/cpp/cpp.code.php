...
<html>
    <head>
    <title>eVerify CPP QUESTION</title>
    <meta charset="UTF-8">
    ...
    <body>
        <nav>
            <div class="nav-wrapper red">
                <a><img id="image" class="brand-logo logo-img s2" src="../../../../logo.png" />
                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                <div class="login center red white-text"><?php echo ""."COORDINATOR"." (".$course_name.")"; ?></div>
            </div>
            </div>
        </div>
        ...
        <script src="cpp.code.elab.js" type="text/javascript"></script>
