...
<html>
    <head>
    <title>eVerify Mathslab Question</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                <div class="login red white-text">CODING AREA FOR MATHSLAB COORDINATOR</div>
        ...
        <script type="text/javascript" src="../../../../Code-mirror/mode/octave/octave.js"></script>
