...
<html>
    <head>
    <title>eVerify OS Question</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                <div class="login red center center-align white-text">CODING AREA FOR OS COORDINATOR</div>
            ...
            <div class="row">
                <div class="col s12 m12 l4 question_div">
                    <div class="card ">
                        ...
                        <div class="login center red white-text" id="resultMsg">RESULT</div>
