...
<html>
<head>
<title>eVerify Requested Courses</title>
    ...
    <nav>
        ...
        <div class="container">
            ...
            <div class="row small-container">
                <div class="card">
                <div class="login red caps white-text">Requested Course</div>
                ...
                <table class="bordered highlight">
                    ...
                    <tr>
                        ...
                        <td><b>Student Name</b></td> 
                            <td><b>Requested Course</b></td>
                        <td><b>Action</b></td>
                    </tr> 
                    </thead>
                    <tbody id="tBody">
                    <?php
                        $sql = " SELECT * FROM $TABLE_NAME WHERE STAFF_ID='$staffID' AND STATUS = 0;";
                        ...
                        if(mysqli_num_rows($db) > 0) {
                            while($row = mysqli_fetch_assoc($db)) {
                                ...
                                echo "<div class=\"options\">
                                        <button class=\"falseBtn btn waves-effect pink waves-light\" type=\"submit\" name=\"action\">Reject</button>
                                        <button class=\"trueBtn btn waves-effect green darken-2 waves-light\" type=\"submit\" name=\"action\">Accept</button></div></td>";
                                /* echo '<div class="options">
                                        <div class=""><img src="crossmark-solid.png" /></div>
                                        <div class=""><img src="checkmark-solid.png" /></div>
                                    </div></td> */
                                echo '</tr>';
                            }
                        }    
