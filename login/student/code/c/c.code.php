...
<html>
    ...
    <title>eVerify C Coding Area</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                <div class="login red white-text">C CODING AREA</div>
            ...
            <div class="row">
                <div class="col s12 m12 l4 question_div">
                    <div class="card ">
                        ...
                        <div class="login disabledcenter red white-text" id="resultMsg">RESULT</div>
